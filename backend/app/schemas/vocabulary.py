...
class TraceEventType(str, Enum):
    """Closed timeline types for Agent Trace reconstruction. Never fabricated."""

    SESSION_STARTED = "SESSION_STARTED"
    CUSTOMER_MESSAGE = "CUSTOMER_MESSAGE"
    INTENT_EXTRACTED = "INTENT_EXTRACTED"
    CATALOGUE_RETRIEVED = "CATALOGUE_RETRIEVED"
    BASKET_CREATED = "BASKET_CREATED"
    BASKET_UPDATED = "BASKET_UPDATED"
    FRICTION_DIAGNOSED = "FRICTION_DIAGNOSED"
    ...
    NEW_BASKET_VERSION_CREATED = "NEW_BASKET_VERSION_CREATED"
    CHECKOUT_CREATED = "CHECKOUT_CREATED"
    RAZORPAY_ORDER_CREATED = "RAZORPAY_ORDER_CREATED"
    CLIENT_PAYMENT_REPORTED = "CLIENT_PAYMENT_REPORTED"
...
class TraceOutcome(str, Enum):
    """Deterministic session-level outcome. Verified payment wins over earlier client noise."""
    ...
    PAYMENT_VERIFIED = "PAYMENT_VERIFIED"
    PAYMENT_FAILED = "PAYMENT_FAILED"
    PURCHASE_PLAN_REJECTED = "PURCHASE_PLAN_REJECTED"


class TraceAudience(str, Enum):
    MERCHANT = "merchant"
    CUSTOMER = "customer"
